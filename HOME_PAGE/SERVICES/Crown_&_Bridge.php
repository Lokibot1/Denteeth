...
if (isset($_POST['update'])) {
  ...
  if (mysqli_query($con, $insert_patient_query)) {
    ...
    if (mysqli_query($con, $insert_appointment_query)) {
      ...
      header("Location: Crown_&_Bridge.php");
      exit();
    } else {
      ...
      <div id="myModal" class="modal">
        <div class="modal-content">
          ...
          <form method="POST" action="">
            ...
            <input type="text" id="modal-service_type_display" value="Crown & Bridge" disabled>
            <input type="hidden" name="service_type" id="modal-service_type" value="2">
            <br>
