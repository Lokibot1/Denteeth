...
$service_name = isset($_GET['service_name']) ? htmlspecialchars($_GET['service_name']) : 'Dental Implants';
...
if (isset($_POST['update'])) {
  ...
  if (mysqli_query($con, $insert_patient_query)) {
    ...
    if (mysqli_query($con, $insert_appointment_query)) {
      ...
      header("Location: Dental_Implants.php");
      exit();
    } else {
      ...
      <div id="myModal" class="modal">
        <div class="modal-content">
          ...
          <form method="POST" action="">
            ...
            <input type="text" id="modal-service_type_display" value="Dental Implants" disabled>
            <input type="hidden" name="service_type" id="modal-service_type" value="4">
            <br>
