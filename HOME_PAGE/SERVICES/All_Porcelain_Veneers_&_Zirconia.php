...
$service_name = isset($_GET['service_name']) ? htmlspecialchars($_GET['service_name']) : 'All Porcelain Veneers & Zirconia';
...
if (isset($_POST['update'])) {
  ...
  if (mysqli_query($con, $insert_patient_query)) {
    ...
    if (mysqli_query($con, $insert_appointment_query)) {
      ...
      header("Location: All_Porcelain_Veneers_&_Zirconia.php");
      exit();
    } else {
      ...
      <div id="myModal" class="modal">
        <div class="modal-content">
          ...
          <form method="POST" action="">
            ...
            <input type="text" id="modal-service_type_display" value="All Porcelain Veneers & Zirconia" disabled>
            <input type="hidden" name="service_type" id="modal-service_type" value="1">
            <br>
