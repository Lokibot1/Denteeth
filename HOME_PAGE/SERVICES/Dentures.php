...
$service_name = isset($_GET['service_name']) ? htmlspecialchars($_GET['service_name']) : 'Dentures';
      ...
      <div id="myModal" class="modal">
        <div class="modal-content">
          ...
          <form method="POST" action="">
            ...
            <input type="text" id="modal-service_type_display" value="Dentures" disabled>
            <input type="hidden" name="service_type" id="modal-service_type" value="6">
            <br>
