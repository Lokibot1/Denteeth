    ...
    <div>
        <aside class="sidebar">
            <ul>
                ...
                <li class="active"><a href="week.php">Appointment for the week</a></li>
                ...
                if (mysqli_num_rows($result) > 0) {
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        <td>
                            ...
                            style='background-color:#083690; color:white; border:none; padding:7px 9px; border-radius:10px; margin:7px 1px; cursor:pointer;'>Update</button>
                            <form method='POST' action='' style='display:inline;'>
                                ...
                                <input type='submit' name='decline' value='Decline' onclick=\"return confirm('Are you sure you want to remove this record?');\" 
                                 style='background-color: rgb(196, 0, 0); color:white; border:none;  padding:7px 9px; border-radius:10px; margin:7px 1px; cursor:pointer;'>
                            </form>";
                        ...
                        if ($row['status'] != 'finished') {
                            ...
                            style='background-color:green; color:white; border:none;  padding:7px 9px; border-radius:10px; margin:7px 1px; cursor:pointer;'>
                        </form>";
                        }
